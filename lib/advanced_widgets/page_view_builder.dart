          ...
          return SafeArea(
            child: Column(
              children: [
                ...
                const Text(
                    "T H A N K Y O U F O R V I S I T O U R A P P  L I C A T I O N"),
                const SizedBox(
                  height: 40,
                ),
...
Widget customIndicator({required int currentIndex}) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.center,
    children: [
      Container(
        height: currentIndex == 0 ? 18 : 15,
        width: currentIndex == 0 ? 18 : 15,
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
          color:
              currentIndex == 0 ? Colors.blue.shade900 : Colors.blue.shade100,
        ),
      ),
      const SizedBox(
        width: 20,
      ...
      Container(
        height: currentIndex == 1 ? 18 : 15,
        width: currentIndex == 0 ? 18 : 15,
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
          color:
              currentIndex == 1 ? Colors.blue.shade900 : Colors.blue.shade100,
        ),
      ),
      const SizedBox(
        width: 20,
      ...
      Container(
        height: currentIndex == 2 ? 18 : 15,
        width: currentIndex == 2 ? 18 : 15,
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
          color:
              currentIndex == 2 ? Colors.blue.shade900 : Colors.blue.shade100,
        ),
      )
    ],
  );
